main:
  ...
  slt  x19,x12,x4; x19 = 0x0
  srli x20,x13,0x1; x20 = 0x20000000
  and  x21,x14,x6; x21 = 0x0
  sub  x22,x5,x1; x22 = 0x7FFFFFFF
  addi x23,x10,0x1; x23 = 0x3
  or   x24,x16,x9; x24 = 0xFFFFFFFB
  xor  x25,x19,x11; x25 = 0x1
  andi x26,x20,0xF; x26 = 0x200000FF
  add  x27,x18,x3; x27 = 0x80000001
  srl  x28,x20,x2; x28 = 0x01000000
  ori  x29,x19,0xA; x29 = 0xAF
